function renderMenu() {
    ...
    var selectedElement = document.getElementById('js-Menu__Select1').value;
    var selectedSize = document.getElementById('js-Menu__Select2').value;
    var selectedColor = document.getElementById('js-Menu__Select3').value;
    ...
    selectElement3.addEventListener('change', (event) => {
        ...
        if (selectedElement.includes('article') || selectedElement.includes('section')) {
            var number = selectedElement.split(' ')[1];
